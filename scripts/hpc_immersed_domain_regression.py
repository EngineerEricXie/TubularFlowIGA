#!/usr/bin/env python3
"""Check distributed immersed graph-domain transactions and serial port/field parity."""
import argparse
import json
import math
import os
...
def main():
    ...
    binary = repo/'solvers/cpu/immersed_distributed_domain_test'
        ...
        for ranks, split in cases:
            ...
            for rank in range(ranks):
                ...
                lines = [line for line in (rd/'stdout.log').read_text().splitlines()
                         if line.startswith('immersed_domain_mpi ')]
