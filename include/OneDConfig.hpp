...
enum class OneDFlowScheme { SteadyPoiseuille, Petsc, ExplicitRusanov, ImplicitPetsc };
enum class OneDImplicitFormulation { SteadyR, TransientRc, TransientRlc, NonlinearRlc, ImplicitPde };
