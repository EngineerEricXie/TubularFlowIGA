...
def convert_vtk_to_custom_obj(scale, vtk_filename, obj_filename):
    ...
    if "radius" in mesh.point_data:
        radii = 0.5*mesh.point_data["radius"]
    else:
    ...
    with open(obj_filename, 'w') as f:
        ...
        print(f"Conversion complete. OBJ file saved as {obj_filename}")

# Execute the conversion
vtkfilename = 'Input/UIC55_B1/UIC55_B1_centerline.vtk'
objfilename = 'Input/UIC55_B1/skeleton_initial.obj'
