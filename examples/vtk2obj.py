...
def convert_vtk_to_custom_obj(vtk_filename, obj_filename):
...
vtkfilename = 'AGH50_centerline.vtk'
objfilename = 'AGH50_centerline.obj'
convert_vtk_to_custom_obj(vtkfilename, objfilename)
