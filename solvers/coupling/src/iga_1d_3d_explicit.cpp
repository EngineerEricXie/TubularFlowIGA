...
int main(int argc, char** argv)
{
	...
	try {
		...
		const auto upstream_terminal_runtime_id = "outlet:"+std::to_string(options.upstream_terminal_node);
		...
		const auto downstream_terminal_runtime_id = "outlet:"+std::to_string(
